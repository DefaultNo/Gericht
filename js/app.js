 ...
 */            !function(e, t) {
                "use strict";
                true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = t, __WEBPACK_AMD_DEFINE_RESULT__ = "function" === typeof __WEBPACK_AMD_DEFINE_FACTORY__ ? __WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module) : __WEBPACK_AMD_DEFINE_FACTORY__, 
    ...
    (() => {
        ...
        if (document.querySelectorAll(".select__options").length) document.querySelectorAll(".select__options").forEach((scrollBlock => {
        ...
        class ScrollWatcher {
            ...
            getScrollWatcherConfig(paramsWatch) {
                let configWatcher = {};
                if (document.querySelector(paramsWatch.root)) configWatcher.root = document.querySelector(paramsWatch.root); else if ("null" !== paramsWatch.root) return;
            ...
            scrollWatcherIntersecting(entry, targetElement) {
                if (entry.isIntersecting) !targetElement.classList.contains("_block-visible") ? targetElement.classList.add("_block-visible") : null; else targetElement.classList.contains("_block-visible") ? targetElement.classList.remove("_block-visible") : null;
            }
        ...
        techModule.watcher = new ScrollWatcher({});
        class Popup {
            constructor(options) {
                let config = {
                    logging: true,
        ...
        techModule.select = new SelectConstructor({});
        ...
        if (document.querySelector(".home__slider")) new core(".home__slider", {
            ...
            on: {
                init: () => {
                    const control = document.querySelectorAll(".home__controll .swiper-pagination-bullet");
                    control.forEach(((element, id) => {
                        let num = id < 10 ? "0" : "";
                        element.innerHTML = `${num}${id + 1}`;
                    }));
                }
            }
        });
        ...
        var baguetteBox_min = __webpack_require__(5731);
        window.addEventListener("load", (() => {
            baguetteBox_min.run(".slider-gallery__wrapper", {
                animation: "fadeIn",
                buttons: false,
                bodyClass: "lock"
            });
        ...
        datepicker_min(".form-book__datepicker", {
            customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
            customMonths: [ "Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь" ],
            formatter: (input, date, instance) => {
                const value = date.toLocaleDateString("uk-UA");
                input.value = value;
            },
            minDate: new Date,
            maxDate: date,
            overlayPlaceholder: "Выберите месяц",
            overlayButton: "Выбрать",
            onShow: instance => {
                instance.calendarContainer.closest(".form-book__date").classList.add("_active");
            },
            onHide: instance => {
                instance.calendarContainer.closest(".form-book__date").classList.remove("_active");
            }
        });
        ...
        da.init();
        const headerNav = document.querySelector(".header__nav"), burgerTarget = document.querySelector(".header__burger");
        const script_button = document.querySelectorAll(".btn");
        ...
        window.addEventListener("load", (() => {
            ...
            if (script_button) for (let i = 0; i < script_button.length; i++) {
                script_button[i].addEventListener("mouseenter", (e => {
                    let x = e.offsetX;
                    let y = e.offsetY;
                    e.target.querySelector("span").style.cssText = `top: ${y}px; left: ${x}px`;
                }));
                script_button[i].addEventListener("mouseleave", (e => {
                    let x = e.offsetX;
                    let y = e.offsetY;
                    e.target.querySelector("span").style.cssText = `top: ${y}px; left: ${x}px`;
                }));
        ...
        if (document.querySelector(".video")) document.addEventListener("watcherCallback", (e => {
            const entry = e.detail.entry;
            const targetElement = entry.target;
